...
public:
	...
	void resize();
	int array_to_list_index(int array_index);
	int list_to_array_index(int list_index);
	int first_empty_function();
	void addExtraCase(TElem e);
	TElem remove_head(ListIterator& pos);
	TElem remove_tail(ListIterator& pos);
